# Como contribuir com o Guia de Grunt
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique (diga no texto se é pago ou em inglês, sem emblemas).
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-curso-grunt`).
2. Edite o `README.md`.
